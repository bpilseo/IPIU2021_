...
from core import tnwls
from core import model_inv_den
######################################################
...
net = tnwls.MobileFacenet()

ArcMargin = tnwls.ArcMarginProduct(128, len(trainset.classes), s=32, m=0.5)
...
best_acc = 0.0
best_epoch = 0
# progress_bar = tqdm.tqdm(trainloader)
for epoch in range(start_epoch, TOTAL_EPOCH+1):
    ...
    if epoch % TEST_FREQ == 0:
        ...
        # save tmp_result
        scipy.io.savemat('C:\\Users\\pc\\Desktop\\PythonWorkSpace\\face_rec2\\MobileFaceNet_Pytorch\\result\\tmp_result.mat', result)
        accs = evaluation_10_fold('\\Users\\pc\\Desktop\\PythonWorkSpace\\face_rec2\\MobileFaceNet_Pytorch\\result\\tmp_result.mat')
