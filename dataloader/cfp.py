...
if __name__ == '__main__':
    root = 'D:\\dataset\\cfp-dataset\\cfp-dataset'
    file_list = 'cfp-fp-pair.txt'
    ...
    trainloader = data.DataLoader(dataset, batch_size=64, shuffle=False, num_workers=0, drop_last=False)
